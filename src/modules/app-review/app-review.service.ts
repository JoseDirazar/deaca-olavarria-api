...
export class AppReviewService {
    constructor(@InjectRepository(AppReview) private readonly appReviewRepository: Repository<AppReview>) { }

    async findAll() {
        const reviews = await this.appReviewRepository.createQueryBuilder("appReview")
