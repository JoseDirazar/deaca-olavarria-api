import { Controller, Post, Body, BadRequestException, Get, Param, UseGuards, Put, Delete, ParseUUIDPipe } from "@nestjs/common";
...
export class EventController {
    ...
    @Put(':id')
    async updateEvent(@Param('id', new ParseUUIDPipe()) id: string, @Body() eventDto: EventDto): Promise<Event | null> {
